            ...
            <div className="w-full h-full rounded-[12px] bg-white">
                <div className="bg-white rounded-2xl w-full h-full min-h-[80vh] p-6 overflow-y-auto">
                    ...
                    <div className="bg-[#7284FB] rounded-xl p-6 w-full max-w-md mx-auto space-y-4 text-white">
                        {[{ label: 'Nombre', name: 'nombre' }, { label: 'Apellidos', name: 'apellidos' }, { label: 'Correo', name: 'correo', type: 'email' }, { label: 'Contraseña', name: 'contrasena', type: 'password' }, { label: 'Placa de Unidad', name: 'placa' }].map(({ label, name, type = 'text' }) => (
                            <div key={name}>
                        ...
                        <div className="flex justify-center pt-4 gap-6">
                            ...
                            <button
                                ...
                                onClick={async () => {
                                    const payload = buildPayload(form, 'chofer')
