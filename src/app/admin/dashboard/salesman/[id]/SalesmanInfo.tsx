...
export default function SalesmanInfo() {
    ...
    const salesman = users.find((u) => u.id === id && u.rol === 'prevendedor')
    ...
    if (!salesman) {
        return <div className="text-center mt-10">Prevendedor no encontrado</div>
    }
    ...
    return (
        <div className="bg-white rounded-2xl shadow-lg w-full max-w-5xl h-full min-h-[80vh] p-6 flex flex-col">
            <h1 className="text-xl font-semibold text-[#7284FB] mb-2">
                Detalle de {salesman.nombre} {salesman.apellidos}
            </h1>
            ...
            <div className="bg-[#7284FB] text-white rounded-xl p-6 relative flex flex-col md:flex-row items-center gap-6">
                <button
                    onClick={() => router.push(`/admin/dashboard/salesman/${id}/edit`)}
                ...
                <div className="flex flex-col items-center ml-5 mr-10">
                    ...
                    <div className="font-semibold text-lg">{salesman.nombre} {salesman.apellidos}</div>
                    <button
                ...
                <div className="flex-1 space-y-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <div className="bg-white text-gray-800 rounded-full px-4 py-2 mt-1">
                                {salesman.apellidos || 'No registrado'}
                            </div>
                        </div>
                        <div>
                            <label className="text-sm">Tipo de documento</label>
                            <div className="bg-white text-gray-800 rounded-full px-4 py-2 mt-1">
                                {salesman.tipoDocumento || 'No registrado'}
                            </div>
                        </div>
                        <div>
                            <label className="text-sm">N° Documento</label>
                            <div className="bg-white text-gray-800 rounded-full px-4 py-2 mt-1">
                                {salesman.numeroDocumento || 'No registrado'}
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <div className="bg-white text-gray-800 rounded-full px-4 py-2 mt-1 flex items-center justify-between">
                                <span className="truncate">
                                    {showPassword ? salesman.contrasena : '***********'}
                                </span>
                                <button
                ...
                <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
                    <div className="bg-white rounded-xl p-6 w-80 text-center space-y-4">
                        <h2 className="text-lg font-semibold text-[#7284FB]">
                            ¿Estás seguro de desactivar la cuenta de {salesman.nombre}?
                        </h2>
            ...
            <div className="flex justify-center mt-6">
                <button
                    onClick={() => router.push('/admin/dashboard/salesman')}
